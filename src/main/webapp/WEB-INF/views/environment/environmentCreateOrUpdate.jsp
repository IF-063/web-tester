    ...
    <div class="panel body">
        <div class="row">
            <form:form class="form-horizontal" role="form" method="POST"
                modelAttribute="environment" action="">
                <fieldset>
                    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <form:input path="timeMultiplier"
                                    ...
                                    class="form-control"
                                    id="timeMultiplier" placeholder="2"
                                    cssErrorClass="error" />
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <c:url
                                        value="/configuration/environments"
                                        var="environments" />
                                    <c:choose>
                                        <c:when test="${not empty id}">
                                            <c:url
                                                value="/configuration/environments/${id}"
                                                var="resetButton" />
                                        </c:when>
                                        <c:otherwise>
                                            <c:url
                                                value="/configuration/environments/create"
                                                var="resetButton" />
                                        </c:otherwise>
                                    </c:choose>
                                    <button type="reset"
