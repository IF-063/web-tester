        		 ...
        		 <div class="panel panel-default">
                        ...
                        <c:if test="${not empty error}">
                        	<div class="alert alert-danger col-sm-12">
  								<a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
  								<strong>Not success!</strong><c:out value='${error}' />
							</div>
                        </c:if>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-sm-offset-4 col-sm-8">
                                    ...
                                    <button type="submit" class="btn btn-success btn-lg pull-right" onclick="location.href='${environmentCreate}'">Create</button>
                                </div>
                            </div>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                    	<c:forEach items="${environmentList}" var="environment">
                                    		<tr>
                                    			<c:url value="/environments/check/${environment.id}" var="environmentCheckUrl" />
                                    			<c:url value="/environments/${environment.id}" var="environmentUpdateUrl" />
                                    			<c:url value="/environments/delete/${environment.id}" var="environmentDeleteUrl" />
                                    			<td><a href="${environmentUpdateUrl}">${environment.name}</a></td>
